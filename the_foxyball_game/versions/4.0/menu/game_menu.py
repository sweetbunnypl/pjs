...
#WYSWIETLANIE TEKSTU        
        if txt1:
            ...
            textRect.center = (WIDTH/2, 250*self.mnoznik_obiektow)
            self.screen.blit(text, textRect)
        if txt2:
            textRect2 = text2.get_rect()
            textRect2.center = (WIDTH/2, 300*self.mnoznik_obiektow)
            self.screen.blit(text2, textRect2)     
        if txt3:
            textRect3 = text3.get_rect()
            textRect3.center = (WIDTH/2, 350*self.mnoznik_obiektow)
            self.screen.blit(text3, textRect3)
        if txt4:
            textRect4 = text4.get_rect()
            textRect4.center = (WIDTH/2, 400*self.mnoznik_obiektow)
            self.screen.blit(text4, textRect4)
        if txt5:
            textRect5 = text5.get_rect()
            textRect5.center = (WIDTH/2, 450*self.mnoznik_obiektow)
            self.screen.blit(text5, textRect5)
        if txt6:
            textRect6 = text6.get_rect()
            textRect6.center = (WIDTH/2, 500*self.mnoznik_obiektow)
        ...
        if self.txt7 and not txt6:
            ...
            textRect7.center = (WIDTH/2, 500*self.mnoznik_obiektow)
...
#OBECNY TYTUŁ - USTAWIENIA
        ...
        if self.menu_position[0] == 1 and self.menu_position[1] == 1 and self.n == 2:
            text0_0 = font0_0.render("WIELKOSC OKNA", True, BLACK)
        #FIZYKA
